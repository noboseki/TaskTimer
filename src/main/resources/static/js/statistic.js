...
function getTableData() {
    ...
    api.get('http://localhost:8080/session/getTableByDate/' + inputFromDate.value + "/" + inputToDate.value)
        .then(res => {
            tableBody.innerHTML = "";
            res.data.forEach(f => {
...
function getChainDataAndBuild() {
    ...
    api.get('http://localhost:8080/session/getChainByDate/' + inputFromDate.value + "/" + inputToDate.value)
        .then(res => {
